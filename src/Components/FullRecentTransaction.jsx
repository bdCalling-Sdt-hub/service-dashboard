      ...
      <div className="text-black bg-primary">
        ...
        <div className="flex justify-between border-b py-[16px]">
          ...
          <div className="flex justify-center gap-4 items-center pt-[16px]">
            <p className="px-[35px] cursor-pointer py-[10px] bg-white border-2 border-[green] text-[green] rounded-lg">Download</p>
            <p className="px-[55px] cursor-pointer py-[10px] bg-[green] text-white rounded-lg">
              {/* Regular P550 */}
              Print
            </p>
          </div>
